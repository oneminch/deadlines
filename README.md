...
> The current version (on the [`main`](https://github.com/oneminch/Deadlines/tree/main) branch) is built using Vue 3 & Vite.
>
> Code for previous versions built using Vue 2 and then Nuxt are on the [app/v1](https://github.com/oneminch/Deadlines/tree/app/v1) and the [app/v2-nuxt](https://github.com/oneminch/Deadlines/tree/app/v2-nuxt) branches respectively.
...
**Run Unit Tests with [Vitest](https://vitest.dev/)**: `pnpm test:unit`

**Format/Lint with `oxc`**: `pnpm format` / `pnpm lint`
